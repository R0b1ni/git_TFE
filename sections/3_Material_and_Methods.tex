...
\left\{
\begin{aligned}
y_{1,i} &= \sin(\beta_{1,i} - 90°) \times \frac{D_i \sin\left(\frac{s_i''}{D} \times \frac{180°}{\pi}\right)}{2 \cos(\beta_{\infty ,i} - \beta_{1,i})}\\
z_{1,i} &= \frac{y_{1,i}}{\tan(\beta_{1,i} - 90°)}\\
...
\left\{
\begin{aligned}
y_{2,i} &= -\sin(\beta_{2,i} - 90°) \times \frac{D_i \sin\left(\frac{s_i''}{D} \times \frac{180°}{\pi}\right)}{2 \cos(\beta_{2,i} - \beta_{\inf,i})}\\
